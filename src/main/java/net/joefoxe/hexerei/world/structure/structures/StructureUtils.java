...
//
//    public static boolean isFullCube(LevelReader world, BlockPos pos, BlockState state){
//        if(!IS_FULLCUBE_MAP.containsKey(state)){
//            boolean isFullCube = Block.isShapeFullBlock(state.getCollisionShape(world, pos)) || state.getBlock() instanceof LeavesBlock;
...
//    //////////////////////////////////////////////
//
////    public static boolean isBlacklistedForWorld(WorldGenLevel currentWorld, ResourceLocation worldgenObjectID){
////        ResourceLocation worldID = currentWorld.getLevel().getDimensionKey().getLocation();
////
...
////        BlockPos.MutableBlockPos mutable = new BlockPos.MutableBlockPos().setPos(
////                boundingBox.func_215126_f().getX(),
////                chunkGenerator.getMaxBuildHeight() - 20,
////                boundingBox.func_215126_f().getZ());
////
////        BlockGetter blockView = chunkGenerator.func_230348_a_(mutable.getX(), mutable.getZ());
...
//        return blockState.isAir() || blockState.getMaterial().isLiquid() || blockState.getMaterial().canBeReplaced();
//    }
//
//    //////////////////////////////////////////////
//
