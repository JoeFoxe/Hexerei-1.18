...
public class ModPlacements {
    ...
    public static final PlacedFeature MAHOGANY_TREE = PlacementUtils.register("mahogany_tree_placement", ModConfiguredFeatures.MAHOGANY.placed(RarityFilter.onAverageOnceEvery(12), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP_WORLD_SURFACE, BiomeFilter.biome()));
